...
export type RendererArchitecture = 'legacy' | 'rhi';
...
export interface RHIBenchmarkManifest {
    ...
    readonly candidateArchitecture: 'rhi';
...
export type RHIBenchmarkCandidateGateComparison = 'rhi' | 'current-legacy';
...
/** Same-run legacy/RHI inference. Only this gate carries paired CI/significance fields. */
...
export interface RHIBenchmarkCandidateFrozenHardCapGate extends RHIBenchmarkCandidateMetricGateBase {
    ...
    readonly comparison: 'rhi' | 'current-legacy';
    readonly maximumRegressionFraction?: number;
    readonly absoluteMaximum?: number;
