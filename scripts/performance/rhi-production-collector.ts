...
function assertMetadata(
    ...
    if (metadata.backend !== request.backend) {
        collectionFailure('fixture backend differs from its isolated page request');
    }
...
/** Collect the complete 10-scenario, two-backend, seven-round current-RHI matrix. */
