...
class Vector3Notifier extends Vector3 {
     ...
     * @return {Vector3} this
     */
    copy(v: Vector3): Vector3Notifier {
    ...
    clone(): Vector3Notifier {
        ...
        return new this.constructor(elements[0], elements[1], elements[2]) as Vector3Notifier;
    }
     ...
     * @return {Vector3} this
     */
    fromArray(array: number[] | Float32Array, offset: number = 0): Vector3Notifier {
        const elements = this.elements;
     ...
     */
    set(x: number, y: number, z: number): Vector3Notifier {
     ...
     * @returns {Vector3Notifier} this
     */
    add(a: Vector3, b?: Vector3): Vector3Notifier {
        if (!b) {
            b = a;
            a = this;
        }
     ...
     * @returns {Vector3Notifier} this
     */
    subtract(a: Vector3, b?: Vector3): Vector3Notifier {
        if (!b) {
            b = a;
            a = this;
        }
     ...
     * @returns {Vector3Notifier} this
     */
    multiply(a: Vector3, b?: Vector3): Vector3Notifier {
        if (!b) {
            b = a;
            a = this;
        }
     ...
     * @returns {Vector3Notifier} this
     */
    divide(a: Vector3, b?: Vector3): Vector3Notifier {
        if (!b) {
            b = a;
            a = this;
        }
     ...
     * @returns {Vector3Notifier} this
     */
    min(a: Vector3, b?: Vector3): Vector3Notifier {
        if (!b) {
            b = a;
            a = this;
        }
     ...
     * @returns {Vector3Notifier} this
     */
    max(a: Vector3, b?: Vector3): Vector3Notifier {
        if (!b) {
            b = a;
            a = this;
        }
     ...
     * @returns {Vector3Notifier} this
     */
    scale(scale: number): Vector3Notifier {
     ...
     * @returns {Vector3Notifier} this
     */
    scaleAndAdd(scale: number, a: Vector3, b?: Vector3): Vector3Notifier {
        if (!b) {
            b = a;
            a = this;
        }
     ...
     * @returns {Vector3Notifier} this
     */
    inverse(a?: Vector3): Vector3Notifier {
        if (!a) {
            a = this;
        }
     ...
     */
    cross(a: Vector3, b?: Vector3): Vector3Notifier {
        if (!b) {
            b = a;
            a = this;
        }
     ...
     * @returns {Vector3Notifier} this
     */
    lerp(v: Vector3, t: number): Vector3Notifier {
     ...
     * @return {Vector3} this
     */
    hermite(a: Vector3, b: Vector3, c: Vector3, d: Vector3, t: number): Vector3Notifier {
     ...
     * @return {Vector3} this
     */
    bezier(a: Vector3, b: Vector3, c: Vector3, d: Vector3, t: number): Vector3Notifier {
     ...
     * @returns {Vector3Notifier} this
     */
    random(scale?: number): Vector3Notifier {
     ...
     * @returns {Vector3Notifier} this
     */
    transformMat3(m: Matrix3): Vector3Notifier {
     ...
     * @returns {Vector3Notifier} this
     */
    transformMat4(m: Matrix4): Vector3Notifier {
     ...
     * @returns {Vector3Notifier} this
     */
    transformDirection(m: Matrix4): Vector3Notifier {
        const elements = this.elements;
     ...
     * @returns {Vector3Notifier} this
     */
    transformQuat(q: Quaternion): Vector3Notifier {
     ...
     * @return {Vector3} this
     */
    rotateX(origin: Vector3, rotation: number): Vector3Notifier {
     ...
     * @return {Vector3} this
     */
    rotateY(origin: Vector3, rotation: number): Vector3Notifier {
     ...
     * @return {Vector3} this
     */
    rotateZ(origin: Vector3, rotation: number): Vector3Notifier {
