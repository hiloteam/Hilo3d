 ...
 * stage.addChild(node);
 */
const Node = Class.create<typeof hilo3d.Node>()(/** @lends Node.prototype */ {
    Statics: {
        /**
 ...
 * @param {Node} node
 * @return {unknown} Node.TRAVERSE_STOP_NONE | Node.TRAVERSE_STOP_CHILDREN | Node.TRAVERSE_STOP_ALL
 */
