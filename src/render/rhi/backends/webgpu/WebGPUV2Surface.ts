...
import { WebGPUV2DestroyableObject } from './WebGPUV2Base';
import type { WebGPUV2Device } from './WebGPUV2Device';
import { WebGPUV2Texture } from './WebGPUV2Resources';
...
export class WebGPUV2Surface extends WebGPUV2DestroyableObject implements RHISurface {
    ...
    #currentTexture: WebGPUV2Texture | null = null;
    #depthStencilTexture: WebGPUV2Texture | null = null;

    constructor(owner: WebGPUV2Device, nativeContext: GPUCanvasContext, canvas: HTMLCanvasElement) {
    ...
    getCurrentTexture(): RHITexture {
        ...
        this.#currentTexture = new WebGPUV2Texture(this.owner, nativeTexture, descriptor, false);
