...
import { WebGPUDestroyableObject, WebGPUResource } from './WebGPUBase';
...
export class WebGPUTexture
    extends WebGPUResource<RHINormalizedTextureDescriptor>
...
export class WebGPUTextureView extends WebGPUDestroyableObject implements RHITextureView {
...
export class WebGPUSampler
    extends WebGPUResource<RHINormalizedSamplerDescriptor>
...
export class WebGPUShader
    extends WebGPUResource<RHINormalizedShaderDescriptor>
