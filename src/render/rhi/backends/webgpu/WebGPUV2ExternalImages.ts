...
interface WebGPUV2VideoUploadState {
 ...
 */
export class WebGPUV2ExternalImageStager {
    readonly #videos = new WeakMap<HTMLVideoElement, WebGPUV2VideoUploadState>();
    ...
    private videoState(source: HTMLVideoElement): WebGPUV2VideoUploadState {
        ...
        } satisfies WebGPUV2VideoUploadState;
