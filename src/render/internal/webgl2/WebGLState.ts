...
import type { WebGLRHIState } from '../../rhi/webgl2/WebGLInternal';
import type { WebGLRHIDevice } from '../../rhi/webgl2/WebGLDevice';
...
/** Attach the native WebGL2 state adapter to its concrete RHI owner. @internal */
