...
const presenters = new WeakMap<WebGL2Driver, WebGLCanvasPresenter>();
const stateInvalidators = new WeakMap<WebGL2Driver, () => void>();
...
export function presentWebGLTexture(renderer: WebGL2Driver, texture: Texture<unknown>): void {
...
export function releaseWebGLCanvasPresenter(renderer: WebGL2Driver, contextLost = false): void {
...
export function unregisterWebGLCanvasPresenter(renderer: WebGL2Driver): void {
