...
/**
 * @typedef {unknown} ANGLEInstancedArrays
 */

/**
 * @typedef {unknown} OESVertexArrayObject
 */

/**
 * @typedef {unknown} OESTextureFloat
 */

/**
 * @typedef {unknown} EXTFragDepth
 */

/**
 * @typedef {unknown} WebGLLoseContext
 */

/**
 * @typedef {unknown} EXTTextureFilterAnisotropic
 */

/**
 * @typedef {unknown} EXT_sRGB
 */

/**
 * @typedef {unknown} WEBGLDrawBuffers
 */
