...
class Material {
    ...
    addBasicUniforms(): void {
        this.copyBindings(this.uniforms, {
            ...
            u_directionalCascadeSplits: 'DIRECTIONALCASCADESPLITS',
            u_directionalCascadeParams: 'DIRECTIONALCASCADEPARAMS',
            u_directionalCascadeMatrices: 'DIRECTIONALCASCADEMATRICES',
