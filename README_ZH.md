...
* 使用 script 标签加载 [cdn][cdn-url]
    ...
    ```
    <script src='<script src='//cdn.jsdelivr.net/npm/hilo3d@1.15.9-alpha.4/build/Hilo3d.js'></script>'></script>
    ```
...
[cdn-url]: https://cdn.jsdelivr.net/npm/hilo3d@1.15.9-alpha.4/build/Hilo3d.js
