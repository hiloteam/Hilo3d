...
* 使用 script 标签加载 [cdn][cdn-url]
    ...
    ```
   <script src='//cdn.jsdelivr.net/npm/hilo3d@1.18.1-shadow.3/build/Hilo3d.js'></script>
    ```
...
[cdn-url]: https://cdn.jsdelivr.net/npm/hilo3d@1.18.1-shadow.3/build/Hilo3d.js
