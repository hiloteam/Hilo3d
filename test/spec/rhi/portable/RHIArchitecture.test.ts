...
const webGPUV2BaseSource = import.meta.glob<string>(
    '../../../../src/render/rhi/backends/webgpu/WebGPUBase.ts',
    { eager: true, query: '?raw', import: 'default' }
);
...
describe('RHI core architecture', () => {
...
describe('WebGPU RHI render-pass hot-path architecture', () => {
...
describe('WebGPU RHI frame-retention hot-path architecture', () => {
