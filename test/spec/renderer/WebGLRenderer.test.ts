...
import { getWebGLTexture, webGLStateUsesRHI } from '../../../src/renderer/webgl/WebGLState';
import type { WebGLRHI } from '../../../src/rhi/webgl/WebGLRHI';
import { testEnv } from '../../setup';

const WebGLRenderer = Hilo3d.WebGLRenderer;

function rhiOwner(renderer: InstanceType<typeof WebGLRenderer>): WebGLRHI {
