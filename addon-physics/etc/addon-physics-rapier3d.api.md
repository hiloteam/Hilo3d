...
// @public
export function bindNode3D(world: PhysicsWorld<'3d'>, body: PhysicsRigidBody<'3d'>, node: Node_2, options?: PhysicsTransformBindingOptions): HiloNodeTransform3D;
...
// Warning: (ae-forgotten-export) The symbol "PhysicsObject" needs to be exported by the entry point rapier3d.d.ts
//
// @public
...
// Warning: (ae-forgotten-export) The symbol "PhysicsColliderDescriptorBase" needs to be exported by the entry point rapier3d.d.ts
//
// @public (undocumented)
...
// Warning: (ae-forgotten-export) The symbol "PhysicsJointDescriptorBase" needs to be exported by the entry point rapier3d.d.ts
//
// @public (undocumented)
...
// Warning: (ae-forgotten-export) The symbol "PhysicsRigidBodyDescriptorBase" needs to be exported by the entry point rapier3d.d.ts
//
// @public (undocumented)
...
// @public (undocumented)
export const RAPIER_3D_NATIVE_EXTENSION: PhysicsBackendExtension<Rapier3DNativeExtension>;
