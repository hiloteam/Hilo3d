...
// Warning: (ae-forgotten-export) The symbol "PhysicsObject" needs to be exported by the entry point rapier2d.d.ts
//
// @public
...
// Warning: (ae-forgotten-export) The symbol "PhysicsColliderDescriptorBase" needs to be exported by the entry point rapier2d.d.ts
//
// @public (undocumented)
...
// Warning: (ae-forgotten-export) The symbol "PhysicsJointDescriptorBase" needs to be exported by the entry point rapier2d.d.ts
//
// @public (undocumented)
...
// Warning: (ae-forgotten-export) The symbol "PhysicsRigidBodyDescriptorBase" needs to be exported by the entry point rapier2d.d.ts
//
// @public (undocumented)
...
export class Rapier2DBackend implements PhysicsBackend<'2d'> {
    // (undocumented)
    createWorld(options: PhysicsBackendWorldOptions<'2d'>): Promise<PhysicsBackendWorld<'2d'>>;
    // (undocumented)
    readonly dimension: "2d";
    // (undocumented)
