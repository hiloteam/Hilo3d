...
| Forward+/高斯/粒子/光追 example/验收 | 已完成   | 组合页覆盖 depth/Scene storage、高斯与 1024 粒子；独立页覆盖 65,536 GPU body，以及焦散、体积散射、动画水面、运动重投影、引导降噪与稳定 bind-group 的 HDR path tracing |
