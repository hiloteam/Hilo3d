...
> [COMPUTE_AND_STORAGE](../COMPUTE_AND_STORAGE.md) and the [current roadmap](../ROADMAP.md). Do not
> restore retired APIs, legacy renderers, or execute proposed commands from this snapshot.
...
>
> 当前生产事实仍以
> [`RENDERING_ARCHITECTURE.md`](.././RENDERING_ARCHITECTURE.md)、当前代码和测试为准。
