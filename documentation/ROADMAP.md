...
Rendering planning update: 2026-09-21. The additions below are recorded requirements, not work in
progress or available APIs. Priorities express the recommended order, not delivery dates.
...
| ----------------------------------------------------------------------------------------------- | -------------------------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [REFL0](./MODERN_WEBGPU_RENDERING_ROADMAP.md#refl0-local-reflection-probes)                     | P1                         | Not started | Local cubemaps, parallax correction, bounded probe blending and a common SSR/environment fallback; static captures before budgeted dynamic capture.                             | Room transitions, offscreen reflectors, roughness/mip behavior, no duplicate specular energy, atomic capture publication and device recovery.                |
...
prioritize REFL0 -> DECAL0 -> TRANS0. This is a recommended sequence, not an artificial dependency
between independent features. RG1 starts with measured CPU/transient-memory pressure; MAT1 and
DEFORM0 need representative material or animated-character content. A0 -> M0 remains the independent
streaming and geometry lane. Existing performance evidence gates stay open until their own
acceptance passes.
