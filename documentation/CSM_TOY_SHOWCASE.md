...
- 清晨／黄昏切换用约 5 秒同步渐变天空、海水、河水和场景照明；中途反向切换从当前亮度继续。黄昏按顺序渐亮窗户、三盏路灯、车头灯和灯塔，每盏约 1.8 秒，路灯间隔 0.6 秒，整组约 4.8 秒完成；切回清晨也会渐暗熄灯。局部投影使用五盏 512²
  SpotLight，阴影视锥与每盏灯的方向、光锥和范围匹配。路灯以暖白色垂直照向灯杆周围，宽半影柔和收边，与房间的琥珀色区分；所有照明过渡独立于列车的暂停状态。
- 河水、海面、天空和天气使用可移植 GLSL ES
  3.00 与注册的 std140 数据，继续经过共享渲染链。河水与 PBR 场景使用一致的距离平方反比衰减和有限范围渐隐，避免远处灯光过强、河面亮斑过曝，以及超出阴影范围后的突兀漏光。
- 积雪由真实朝上表面生成，覆盖地面、屋顶、桥面和树冠；排除火车、风车转子、玻璃和水体。运行时约 25 秒积满，停雪后约 20 秒融化，设置面板也可直接调整积雪量。
- 雷雨支持偶发及手动闪电；系统减少动态效果时禁用自动闪电。闪电按触发后的真实时间衰减，独立于粒子动画的逐帧 delta 限制，低帧率及暂停运动时也不会把短脉冲拉长成持续照明。
